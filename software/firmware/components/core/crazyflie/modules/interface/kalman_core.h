...
// Measurement of attitude using accelerometer (gravity direction) - for use without external sensors
void kalmanCoreUpdateWithAccel(kalmanCoreData_t *this, const Axis3f *accWorld, float stdDev);
